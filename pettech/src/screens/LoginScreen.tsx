  ...
  return (
    ...
    >
      <Text
        style={[
          theme.styles.text,
          { fontSize: 44, marginBottom: 20, fontWeight: "bold", margin: 10 },
        ]}
      >
        Iniciar Sesión
      </Text>
      <TextInput
        ...
        ]} // Utiliza el estilo del theme para el input
      ...
      />
      {error ? (
        <Text style={[theme.styles.errorText, { marginBottom: 10 }]}>
          {error}
        </Text>
      ) : null}
      <TouchableOpacity
        style={[
          theme.styles.button,
          { marginBottom: 10, width: 200, height: 60, alignItems: "center" },
        ]} // Personaliza los estilos del botón aquí
        onPress={handleLogin}
      >
        <Text style={{ ...theme.styles.buttonText, fontSize: 26 }}>
          Iniciar Sesión
        </Text>
      </TouchableOpacity>
    </View>
